...
{
    public abstract class Ed2kClientBase<TSettings> : DownloadClientBase<TSettings>
        where TSettings : IProviderConfig, new()
    {
        ...
        protected Ed2kClientBase(ITorrentFileInfoReader torrentFileInfoReader,
        ...
        protected abstract string AddFromEd2kLink(RemoteMovie remoteMovie, string hash, string magnetLink);
        ...
        private async Task<string> DownloadFromWebUrl(RemoteMovie remoteMovie, IIndexer indexer, string torrentUrl)
        {
            ...
            var actualHash = AddFromEd2kLink(remoteMovie, hash, filename);
        ...
        private string DownloadFromMagnetUrl(RemoteMovie remoteMovie, IIndexer indexer, string magnetUrl)
        {
            ...
            if (hash != null)
            {
                ...
                actualHash = AddFromEd2kLink(remoteMovie, hash, magnetUrl);
            }
