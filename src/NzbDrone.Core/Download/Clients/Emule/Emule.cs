...
namespace NzbDrone.Core.Download.Clients.Emule
{
    public class Emule : TorrentClientBase<EmuleSettings>
    {
        ...
        private static IEnumerable<string> HandleTags(RemoteMovie remoteMovie, EmuleSettings settings)
        {
        ...
        {
            _proxy.AddTorrentByUrl(magnetLink, remoteMovie, HandleTags(remoteMovie, Settings), Settings);
