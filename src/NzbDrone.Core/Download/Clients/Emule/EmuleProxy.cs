...
namespace NzbDrone.Core.Download.Clients.Emule
{
    public interface IEmuleProxy
    {
        ...
        void AddTorrentByUrl(string url, RemoteMovie remoteMovie, IEnumerable<string> tags, EmuleSettings settings);
    ...
    public class EmuleProxy : IEmuleProxy
    {
        ...
        */
        ...
        public void AddTorrentByUrl(string url, RemoteMovie remoteMovie, IEnumerable<string> tags, EmuleSettings settings)
        {
            ...
            var ed2kurlFormater = "ed2k://|file|" + Uri.EscapeDataString(remoteMovie.Release.Title)  + "|" + remoteMovie.Release.Size + "|" + cadenaExtraida + "|/";
